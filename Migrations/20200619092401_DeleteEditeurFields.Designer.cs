...
namespace PickAndPlay.Migrations
{
    ...
    [Migration("20200619092401_DeleteEditeurFields")]
    partial class DeleteEditeurFields
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PickAndPlay.Models.Genre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PickAndPlay.Models.ActualiteImage", b =>
                {
                    b.HasOne("PickAndPlay.Models.Actualite", "Actualite")
                        .WithMany("ActualitesImages")
                        .HasForeignKey("IdActualite")
                        .HasConstraintName("FK_ActualiteImage_Actualite")
                        .IsRequired();

                    b.HasOne("PickAndPlay.Models.Image", "Image")
                        .WithMany("ActualitesImages")
            ...
            modelBuilder.Entity("PickAndPlay.Models.ConsoleJeu", b =>
                {
                    b.HasOne("PickAndPlay.Models.ConsoleDeJeu", "ConsoleDeJeu")
                        .WithOne("ConsoleJeu")
            ...
            modelBuilder.Entity("PickAndPlay.Models.Jeu", b =>
                {
                    b.HasOne("PickAndPlay.Models.Editeur", "EditeurNavigation")
                        .WithMany("Jeux")
            ...
            modelBuilder.Entity("PickAndPlay.Models.JeuGenre", b =>
                {
                    b.HasOne("PickAndPlay.Models.Genre", "Genre")
                        .WithMany("JeuxGenres")
            ...
            modelBuilder.Entity("PickAndPlay.Models.MagasinImage", b =>
                {
                    b.HasOne("PickAndPlay.Models.Image", "Image")
                        .WithMany("MagasinsImages")
                        .HasForeignKey("IdImage")
                        .HasConstraintName("FK_MagasinImage_Image")
                        .IsRequired();

                    b.HasOne("PickAndPlay.Models.Magasin", "Magasin")
                        .WithMany("MagasinsImages")
